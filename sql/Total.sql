...
CREATE USER java IDENTIFIED BY oracl     e;
=======

CREATE USER 생성유저명 IDENTIFIED BY 비밀번호;
CREATE USER java IDENTIFIED BY oracle;
>>>>>>> bdfeff4fb68586484b3818d19270638e92fb2e12
...
프로시저(procedure) :
     업무적으로 복잡한 구문을 별도의 구문을 작성하여 DB에 저장하고 실행가능
...
트랜잭션(Transaction) :
     ‘거래’ 라는 뜻으로 은행에서 사용하는 입금과 출금을 하는 거래를 말한다.
