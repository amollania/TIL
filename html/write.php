    <form class="form-signin" action="upload.php" method="get" target="submitBox">
        ...
        <input type="email" id="inputEmail" class="form-control" placeholder="이메일 주소" name="te" required="" autofocus="" />
        <label for="inputTitle" class="sr-only">Title</label>
        <input type="text" id="inputTitle" class="form-control" placeholder="제목 입력" name="tt" style="margin-bottom: 10px;" required="" autofocus="">
        ...
        <textarea class="form-control" id="inputTextarea" name="tc" cols="30" rows="10" placeholder="문의내용" required="" autofocus=""></textarea>
